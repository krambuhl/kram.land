...
export function Home({ photo }: HomeProps) {
  return (
    <PageContainer>
      <Area width={tokens.size.x384}>
        <Stack gap={tokens.size.x48} align="center">
          <Card padding="none">
            <img {...photo} alt="" loading="eager" decoding="sync" fetchPriority="high" />
          </Card>
          ...
          <Stack gap={tokens.size.x24} align="center">
            ...
            <BodyText as="p">
              i specialize in <strong>high quality ui</strong> and <strong>thoughtful patterns</strong> to help
